  ...
  <div>
    <div style="flex: 0 0 100%">
      <div mx-auto max-w-600px>
        <c-file-upload :title="t('tools.pdf-linearize.upload-title')" accept=".pdf" @file-upload="onFileUploaded" />
      </div>
    </div>

    <div mt-3 flex justify-center>
      <c-alert v-if="status === 'error'" type="error">
        {{ t('tools.pdf-linearize.error', { file: fileName }) }}
      </c-alert>
      <n-spin
    ...
    <c-card :title="t('tools.pdf-linearize.logs')">
