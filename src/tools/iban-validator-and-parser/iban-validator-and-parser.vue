...
const ibanInfo = computed<CKeyValueListItems>(() => {
  ...
  return [
    ...
    {
      label: t('tools.iban-validator-and-parser.is-iban-valid'),
      value: isIbanValid,
      showCopyButton: false,
    },
    {
      label: t('tools.iban-validator-and-parser.iban-errors'),
      value: errors.length === 0 ? undefined : errors,
      hideOnNil: true,
      showCopyButton: false,
    },
    {
      label: t('tools.iban-validator-and-parser.is-qr-iban'),
      value: isQRIBAN(iban),
      showCopyButton: false,
    },
    {
      label: t('tools.iban-validator-and-parser.country-code'),
      value: countryCode,
    },
    {
    ...
    {
      label: t('tools.iban-validator-and-parser.friendly-format'),
...
<template>
  <div>
    ...
    <c-card :title="t('tools.iban-validator-and-parser.examples-title')" mt-5>
